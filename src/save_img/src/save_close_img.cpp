...
: Node("save_left_img")
{
    i =0;
      ...
      img_sub = this->create_subscription<sensor_msgs::msg::Image>("/image_close", rclcpp::SensorDataQoS(), std::bind(&SaveImg::imgCallBack, this, std::placeholders::_1));
...
void SaveImg::imgCallBack(const sensor_msgs::msg::Image::SharedPtr msg)
{
    ...
    RCLCPP_INFO(this->get_logger(), "success to save leftimg!");
